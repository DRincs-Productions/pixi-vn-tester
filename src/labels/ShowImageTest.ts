import { addImage, CanvasImage, clearDialogue, GameWindowManager, loadImages, newLabel, removeCanvasElement, setDialogue, showWithDissolveTransition, TickerRotate } from "@drincs/pixi-vn"

export const showImageTest = newLabel("ShowImageTest", [
    async () => {
