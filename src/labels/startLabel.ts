...
const startLabel = newLabel("start", [
    ...
    async () => {
        ...
        narration.dialogue = { character: mc, text: `...[mc].` }
    },
    async () => {
        await showImageContainer("james", ["m01-body", "m01-eyes-smile", "m01-mouth-grin00"])
    ...
    async () => {
        ...
        narration.dialogue = { character: james, text: `Ooh, [mc]! Nice, firm handshake!` }
    },
    async () => {
    ...
    async () => {
        ...
        narration.dialogGlue = true
        narration.dialogue = ` Hey, you, [mc]- be nice to our little brother,`
    },
    async () => {
    ...
    async () => {
        ...
        narration.dialogue = { character: james, text: `[mc], this is [sly].` }
    },
    async () => {
    ...
    async () => {
        ...
        narration.dialogue = { character: sly, text: `I'm not shakin' your hand until I decide you're an all-right dude.` }
    },
    async () => {
    ...
    async () => {
        ...
        narration.dialogue = { character: steph, text: `WOW, that is, like, the most perfect handshake I've ever had! Firm, but also gentle.` }
    },
    async () => {
        await showImageContainer("sly", ["fm01-body", "fm01-eyes-upset", "fm01-mouth-upset00"])
        narration.dialogGlue = true
        narration.dialogue = ` [sly], you *gotta* shake his hand!`
    },
    async () => {
        await showImageContainer("james", ["m01-body", "m01-eyes-grin", "m01-mouth-grin00"])
    ...
    async () => {
        ...
        narration.dialogue = { character: james, text: `Don't worry, [mc], she's just giving you the run-down. She's kinda like a father` }
    },
    async () => {
        await showImageContainer("steph", ["fm02-body", "fm02-eyes-wow", "fm02-mouth-nervous00"])
    ...
    async () => {
        ...
        await showImageContainer("sly", ["fm01-body", "fm01-eyes-grin", "fm01-mouth-grin00"])
        await showImageContainer("steph", ["fm02-body", "fm02-eyes-wow", "fm02-mouth-wow01"])
        narration.dialogue = { character: steph, text: `[sly]!` }
    },
    async () => {
        await showImageContainer("steph", ["fm02-body", "fm02-eyes-upset", "fm02-mouth-upset01"])
        narration.dialogGlue = true
...
const secondPart = newLabel("second_part", [
    ...
    async () => {
        ...
        narration.dialogGlue = true
        narration.dialogue = ` That last guy was a druggie, did [james] tell you that?`
    },
    async () => {
        await showImageContainer("james", ["m01-body", "m01-eyes-grin", "m01-mouth-grin00"])
        await showImageContainer("sly", ["fm01-body", "fm01-eyes-grin", "fm01-mouth-smile01"])
    ...
    async () => {
        ...
        narration.dialogue = { character: steph, text: `[sly]! If word gets out about that...` }
    },
    async () => {
        await showImageContainer("sly", ["fm01-body", "fm01-eyes-smile", "fm01-mouth-grin00"])
    ...
    async () => {
        ...
        await showImageContainer("sly", ["fm01-body", "fm01-eyes-smile", "fm01-mouth-serious00"])
        await showImageContainer("steph", ["fm02-body", "fm02-eyes-joy", "fm02-mouth-smile00"])
        narration.dialogue = { character: james, text: `Yeah, I like to say that this last semester I was in *foster care*` }
    },
    async () => {
        narration.dialogGlue = true
        narration.dialogue = `  and [sly] picked me up somewhere in there.`
    },
    async () => {
    ...
    async () => {
        await showImageContainer("sly", ["fm01-body", "fm01-eyes-smile", "fm01-mouth-smile01"])
        narration.dialogGlue = true
        narration.dialogue = ` What are you going for, [mc]?`
    },
    async () => {
        await showImageContainer("sly", ["fm01-body", "fm01-eyes-smile", "fm01-mouth-smile00"])
        await showImageContainer("steph", ["fm02-body", "fm02-eyes-nervous", "fm02-mouth-nervous00"])
    ...
    async () => {
        ...
        await showImageContainer("sly", ["fm01-body", "fm01-eyes-upset", "fm01-mouth-smile01"])
        await showImageContainer("steph", ["fm02-body", "fm02-eyes-nervous", "fm02-mouth-smile00"])
        narration.dialogue = { character: sly, text: `You've gotta live close by, right? Nobody comes to this college from afar, sorry, we're just not that hot of a scene.` }
    },
    async () => {
        await showImageContainer("james", ["m01-body", "m01-eyes-smile", "m01-mouth-smile00"])
        await showImageContainer("sly", ["fm01-body", "fm01-eyes-smile", "fm01-mouth-smile00"])
    ...
    async () => {
        ...
        await showImageContainer("sly", ["fm01-body", "fm01-eyes-smile", "fm01-mouth-serious00"])
        await showImageContainer("steph", ["fm02-body", "fm02-eyes-wow", "fm02-mouth-upset00"])
        narration.dialogue = { character: james, text: `Why? [mc]'ll never meet him.` }
    },
    async () => {
        await showImageContainer("james", ["m01-body", "m01-eyes-smile", "m01-mouth-neutral00"])
        await showImageContainer("steph", ["fm02-body", "fm02-eyes-joy", "fm02-mouth-nervous01"])
        narration.dialogue = { character: steph, text: `Say, [mc], where's the rest of your luggage?` }
    },
    async () => {
        await showImageContainer("steph", ["fm02-body", "fm02-eyes-nervous", "fm02-mouth-nervous00"])
        narration.dialogue = { character: mc, text: `...` }
    ...
    async () => {
        await showImageContainer("james", ["m01-body", "m01-eyes-smile", "m01-mouth-neutral00"])
        await showImageContainer("steph", ["fm02-body", "fm02-eyes-upset", "fm02-mouth-upset01"])
        narration.dialogue = { character: steph, text: `[james], you gotta figure out what you want to *do* in computers. You're not seeing the trees for the forest.` }
    },
    async () => {
        await showImageContainer("james", ["m01-body", "m01-eyes-smile", "m01-mouth-neutral01"])
        await showImageContainer("sly", ["fm01-body", "fm01-eyes-smile", "fm01-mouth-serious00"])
    ...
    async () => {
        ...
        await showImageContainer("james", ["m01-body", "m01-eyes-concern", "m01-mouth-neutral01"])
        await showImageContainer("steph", ["fm02-body", "fm02-eyes-nervous", "fm02-mouth-nervous00"])
        narration.dialogue = { character: james, text: `...hey [mc], are you okay?` }
    },
    async () => {
        await showImageContainer("james", ["m01-body", "m01-eyes-wow", "m01-mouth-neutral00"])
        await showImageContainer("steph", ["fm02-body", "fm02-eyes-wow", "fm02-mouth-nervous00"])
    ...
    async () => {
        ...
        await showImageContainer("steph", ["fm02-body", "fm02-eyes-joy", "fm02-mouth-smile00"])
        narration.dialogGlue = true
        narration.dialogue = ` [james] quickly grabs a few.`
    },
    async () => {
        await showImageContainer("james", ["m01-body", "m01-eyes-grin", "m01-mouth-smile00"])
        await showImageContainer("sly", ["fm01-body", "fm01-eyes-smile", "fm01-mouth-smile01"])
        narration.dialogGlue = true
        narration.dialogue = ` [sly] takes some too.`
    },
    async () => {
        await showImageContainer("james", ["m01-body", "m01-eyes-smile", "m01-mouth-smile00"])
        await showImageContainer("sly", ["fm01-body", "fm01-eyes-smile", "fm01-mouth-smile00"])
    ...
    async () => {
        ...
        await showImageContainer("sly", ["fm01-body", "fm01-eyes-smile", "fm01-mouth-smile01"])
        await showImageContainer("steph", ["fm02-body", "fm02-eyes-joy", "fm02-mouth-smile00"])
        narration.dialogue = { character: sly, text: `Well, then, [mc], we'll have to try out your cooking someday!` }
    },
    async () => {
        await showImageContainer("james", ["m01-body", "m01-eyes-smile", "m01-mouth-smile00"])
        await showImageContainer("sly", ["fm01-body", "fm01-eyes-smile", "fm01-mouth-smile00"])
    ...
    async () => {
        await showImageContainer("james", ["m01-body", "m01-eyes-grin", "m01-mouth-smile01"])
        await showImageContainer("sly", ["fm01-body", "fm01-eyes-smile", "fm01-mouth-smile00"])
        narration.dialogue = { character: james, text: `...who told you you're a scary guy, [mc]?` }
    },
    async () => {
        await showImageContainer("sly", ["fm01-body", "fm01-eyes-smile", "fm01-mouth-serious00"])
        await showImageContainer("steph", ["fm02-body", "fm02-eyes-smile", "fm02-mouth-smile00"])
    ...
    async () => {
        await showImageContainer("steph", ["fm02-body", "fm02-eyes-wow", "fm02-mouth-nervous00"])
        narration.dialogue = `[sly] comes over and sits down beside me. She locks eyes with me.`
    },
    async () => {
    ...
    async () => {
        await showImageContainer("sly", ["fm01-body", "fm01-eyes-upset", "fm01-mouth-serious00"])
        narration.dialogue = { character: mc, text: `...I recommend to her "why don't you end this?" I told her I *hated* her.` }
    },
    async () => {
        await showImageContainer("sly", ["fm01-body", "fm01-eyes-smile", "fm01-mouth-serious00"])
        narration.dialogGlue = true
    ...
    () => { narration.dialogue = { character: mc, text: `And when the first potential couple came in and heard about my story, they blamed` } },
    async () => {
        await showImageContainer("sly", ["fm01-body", "fm01-eyes-wow", "fm01-mouth-serious00"])
        await showImageContainer("steph", ["fm02-body", "fm02-eyes-upset", "fm02-mouth-nervous00"])
        narration.dialogGlue = true
    ...
    () => { narration.dialogue = { character: mc, text: `?!?!` } },
    () => { narration.dialogue = { character: sly, text: `...` } },
    () => { narration.dialogue = { character: sly, text: `...because if you're willing to be honest about whether you want to be here with us or alone elsewhere, *we're* willing to help you either way.` } },
